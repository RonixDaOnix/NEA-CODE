...
def aimTrainer(radius,timeRemaining,scoreMultiplier):
  ...
  while finished:
    ...
    scoreScreen = scoreFont.render(f"your score is: {score}", 1, (0,255,0))
    aimScreen.blit(scoreScreen,(((screenWidth - scoreScreen.get_width())//2),((screenHeight - scoreScreen.get_height())//2)))
    pygame.display.update()
